...
**Backend engineer — ASP.NET Core, payment systems, banking integration.**
Egypt · Arabic / English · Open to permanent and consulting work

---

I build back-office systems for banks — payment switches, clearing and settlement,
credit bureau integration, and identity governance. The software runs inside the
customer's own data centre, the auditors ask questions, and "we'll fix it next sprint"
is not an acceptable answer.

Almost all of it is closed-source and covered by client confidentiality. So rather
than link repositories I can't show, or name institutions I shouldn't, this page
documents **what I've built and how I work** — the part that transfers between jobs.

## Core

| | |
|---|---|
| **Platform** | .NET 10 / 9 / 8 · C# · ASP.NET Core · EF Core · gRPC · Protobuf |
| **Payments & integration** | ISO 8583 · payment switching · ACH clearing and settlement · instant payments · credit bureau · regulatory reporting |
| **Architecture** | Modular monolith · Clean Architecture · DDD · CQRS · bounded contexts · transactional outbox · maker-checker governance |
| **Data** | Oracle / PL·SQL · SQL Server · EF Core · Dapper |
| **Delivery** | Docker · GitHub Actions · OpenTelemetry · Serilog · health checks · on-premise deployment |
...
| **Domains** | Retail & cross-border payments · ACH clearing and settlement · ATM reconciliation · credit bureau integration · AML / goAML reporting · Basel III & IFRS 9 · e-invoicing · identity & access management · approval governance |

</details>

## What I work on

### Banking & payments — current role

Delivery across **16 financial institutions** in Egypt and the Gulf: a national
central bank, tier-1 Gulf commercial banks, an agricultural development bank,
Islamic and conventional retail banks, and a national canal authority — plus ACH
work for the East African market.
...
- **ISO 8583 payment switch interface** — Java / Spring Boot, built on Spring
  ...
  tool for it.
- **Instant payment network integration** for Egypt's national instant-payment
  scheme — API, worker service, bank-facing web UI, a gateway, and a health-check
  monitor as separate deployables.
- **ACH / clearing and settlement** — three ACH systems across two markets; issuer and
...
- **Credit bureau integration** — the recurring engagement across seven institutions:
  e-credit submission and retail desktop clients against Egypt's national credit bureau.
- **Regulatory & reporting** — Basel III / NBFI reporting, IFRS 9 ECL, financial
  inclusion, **goAML** anti-money-laundering reporting, declarations (*Ekrarat*)
  systems for several banks, and estate/inheritance processing.
- **Agricultural payment transfer** — carried from a WebForms original through a
  .NET Core rewrite, with a companion token-validation service.
- **Oracle data engineering** — PL/SQL procedures and schema-merge handling against
  a bank's Oracle estate, plus Excel-to-Oracle loaders, connection managers and
...
A 13-project solution: a gRPC-only system of record with an admin front end.
...
A multi-tenant travel product: **.NET** booking APIs with **TypeScript / Next.js**
admin and supplier dashboards, and a **Python** AI portal built on FastAPI,
LangChain/LangGraph and a Qdrant vector store for retrieval.

### Enterprise & product work — *KorainDev*
...
Most of my commits land in private client repositories, so the counts below include
private contributions.

<img src="./profile/stats.svg" alt="GitHub stats: 3331 total commits, 27 repositories contributed to in the last year" width="467">
